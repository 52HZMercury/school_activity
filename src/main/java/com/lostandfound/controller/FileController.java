...
public class FileController {
    ...
    public void fileUpload(@RequestPart("file") MultipartFile file, HttpServletRequest request ) {
        ...
        String filePath = "D:/文档/新鲜出炉的程序/SpringBoot/LostandFound/src/main/resources/LostandFoundimg";
        ...
        try {
            ...
            dynamicService.addImg("templates/img/dynamic/" +fileName, (Integer) session.getAttribute("uid"),(String)session.getAttribute("dtext"),(String)session.getAttribute("dtag"));
        }
